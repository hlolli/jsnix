...
function Package(deploymentConfig, lock, parent, name, versionSpec, baseDir, production, sourcesCache) {
    ...
    this.source = Source.constructSource(deploymentConfig.registries, baseDir, deploymentConfig.outputDir, name, versionSpec, deploymentConfig.stripOptionalDependencies, deploymentConfig.useImpureNpmCache);
