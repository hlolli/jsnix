 ...
 */
Source.constructSource = function(registries, baseDir, outputDir, dependencyName, versionSpec, stripOptionalDependencies, useImpureNpmCache) {
    ...
    if(parsedVersionSpec !== null) { // If the version is valid semver range, fetch the package from the NPM registry
        return new NPMRegistrySource(baseDir, dependencyName, parsedVersionSpec, registries, stripOptionalDependencies, useImpureNpmCache);
