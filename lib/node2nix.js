...
var CollectionExpression = require("./expressions/CollectionExpression.js")
  .CollectionExpression;
var PackageExpression = require("./expressions/PackageExpression.js")
  .PackageExpression;
var CompositionExpression = require("./expressions/CompositionExpression.js")
...
function copyNodeEnvExpr(nodeEnvNix, callback) {
  ...
  var rs = fs.createReadStream(
    path.join(path.dirname(module.filename), "..", "nix", "node-env.nix")
  );
