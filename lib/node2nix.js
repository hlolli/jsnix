...
function npmToNix(inputJSON, outputNix, compositionNix, nodeEnvNix, lockJSON, supplementJSON, supplementNix, production, includePeerDependencies, flatten, nodePackage, registries, noCopyNodeEnv, useImpureNpmCache, bypassCache, useFetchGitPrivate, stripOptionalDependencies, callback) {
    ...
    var deploymentConfig = new DeploymentConfig(registries, production, includePeerDependencies, flatten, nodePackage, outputDir, useImpureNpmCache, bypassCache, stripOptionalDependencies);
    var expr;
