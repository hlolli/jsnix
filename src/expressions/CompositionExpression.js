...
function composePathRelativeToCompositionExpression(compositionNix, exprNix) {
  return prefixRelativePath(
    path.relative(path.dirname(compositionNix), exprNix)
  );
}
...
function CompositionExpression(
  ...
  this.nodeEnvNixPath = composePathRelativeToCompositionExpression(
    compositionNix,
    nodeEnvNix
  );
  this.packagesNixPath = composePathRelativeToCompositionExpression(
    compositionNix,
    packagesNix
  );
  this.supplementNix = composePathRelativeToCompositionExpression(
    compositionNix,
    supplementNix
  );
    ...
    globalBuildInputs = new nijs.NixFunInvocation({
      ...
      paramExpr: new nijs.NixFunInvocation({
        funExpr: new nijs.NixImport(
          new nijs.NixFile({ value: supplementNixPath })
        ),
        paramExpr: {
    ...
    body: new nijs.NixLet({
      value: {
        ...
        nodeEnv: new nijs.NixFunInvocation({
          funExpr: new nijs.NixImport(
            new nijs.NixFile({ value: this.nodeEnvNixPath })
          ),
          paramExpr: {
            stdenv: new nijs.NixInherit("pkgs"),
            lib: new nijs.NixInherit("pkgs"),
      ...
      body: new nijs.NixFunInvocation({
        funExpr: new nijs.NixImport(
          new nijs.NixFile({ value: this.packagesNixPath })
        ),
        paramExpr: {
          fetchurl: new nijs.NixInherit("pkgs"),
          "nix-gitignore": new nijs.NixInherit("pkgs"),
